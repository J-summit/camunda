...
public class SingnalThrowAndBoundayTest {
    ...
    public void createDeployment() {
        ...
        Deployment deployment = deploymentBuilder
            ...
            .addClasspathResource("com/shareniu/ch15/singnal_boundy.bpmn")
            .deploy();
    ...
    public void startProcessInstanceByKey() {
        runtimeService.startProcessInstanceByKey("singnalbounday");
    }
    @Test
