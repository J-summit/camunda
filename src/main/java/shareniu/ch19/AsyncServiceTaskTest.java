...
public class AsyncServiceTaskTest {
    ...
    public void createDeployment() {
        ...
        Deployment deployment = deploymentBuilder
            ...
            .source("本地测试")
            .tenantId("a")
         //   .addClasspathResource("com/shareniu/ch19/async-boundaryevent.bpmn")
            .addClasspathResource("com/shareniu/ch19/async-servicetask.bpmn")
            .deploy();
    ...
    public void createIncident() {
       runtimeService.createIncident("shareniu","101","shareniu-configuration","msg");
     ...
     * Result 1:	update ACT_HI_INCIDENT set CREATE_TIME_ = ?, END_TIME_ = ?, INCIDENT_STATE_ = ?, PROC_DEF_KEY_ = ?, PROC_DEF_ID_ = ?, EXECUTION_ID_ = ?, ACTIVITY_ID_ = ?, JOB_DEF_ID_ = ? where ID_ = ?	Update counts: [1]
     */
    @Test
    public void resolveIncident() {
        runtimeService.resolveIncident("304");
    ...
    public void getCommandExecutor() {
        ...
        service.getCommandExecutor()
            .execute(new ResolveIncidentCmd(incident) );
    }
